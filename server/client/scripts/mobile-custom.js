...
document.addEventListener('DOMContentLoaded', () => {
    ...
    var pwaName = "mioes"; //Local Storage Names for PWA
    ...
    function init_template(){
        ...
        */
        ...
        if(searchField.length){
                            ...
                            if(data.status == true){
                                data.results.forEach((result) => {
                                    ...
                                    <div>
                                        ...
                                        <strong class="color-theme font-16 d-block mt-n2">${result.name}</strong>
                                    </div>
                                    <div class="ms-auto text-center align-self-center pe-2">
                                        <h5 class="line-height-xs font-18 pt-3">${result.pricerange}</h5>
                                        <span class="font-9 d-block mt-n2">Precio medio</span>
                                    </div>
                                    </a>`  
                                    results = results + template;                              
                                })
                                searchResultContainer.innerHTML = results
                            }
                        })                        
                    }
            ...
            let timer; 
            const waitTime = 500; 
            searchField[0].addEventListener('keyup', (e) => { 
                clearTimeout(timer);
                timer = setTimeout(() => {
                    searchFunction()
                }, waitTime);
